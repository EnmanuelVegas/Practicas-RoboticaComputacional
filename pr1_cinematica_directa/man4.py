...
while True:
  L1, tit2, tit3, tit4, L5, L6 = tuple(p)
  # Parámetros D-H:
  #        1     2        3        4  5.1  5.2  6.1  6.2
  d  = [  L1,    0,       0,       5,  L5, -L5,   0,   0]
  th = [   0, tit2, 90+tit3, 90+tit4,  90,  90,   0,   0]
  a  = [   2,    2,       0,       0,   1,   1,  L6,  L6]
  al = [   0,   90,      90,      90,   0,   0,   0,   0]
  ...
  # Puntos auxiliares
  o1p0 = np.dot(T01, [-2, 0 ,0, 1]).tolist()
  o51p0 = np.dot(T051, [-1, 0 ,0, 1]).tolist()
  o52p0 = np.dot(T052, [-1, 0 ,0, 1]).tolist()

  # Mostrar resultado de la cinemática directa
  listaOrigenes = [o00,o1p0,o10, o20, o30, o40, [[o51p0, o510, o610], [o52p0, o520, o620]]]
