...
while True:
  L1, tit2, L3, tit4, tit5 = tuple(p)
  # Parámetros D-H:
  #        1     2     2`   3     4      5.1       5.2
  d  = [  L1,    0,    0,  L3,    0,       0,        0]
  th = [   0, tit2,  -90, -90, tit4, tit5-90, -tit5-90]
  a  = [   0,    5,    0,   0,    0,       2,        2]
  ...
  i += 1
  T22p=matriz_T(d[i],th[i],a[i],al[i])
  T02p=np.dot(T02,T22p)

  i += 1
  T2p3=matriz_T(d[i],th[i],a[i],al[i])
  ...
  listaOrigenes = [o00,o10,o20, o30, o40, [[o510], [o520]]]
